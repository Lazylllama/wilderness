...
export function CampObject({
    ...
    return (
        <div className={cn("absolute", className)} style={{left: `${x}%`,top: `${y}%`, zIndex: depthZ(y), transform: `translate(-56.7%, -100%) scale(${depthScale(y)})`,transformOrigin: "56.7% 100%",...style,}}>{children}</div>
    );
}
...
export function CampStage({
    ...
    return (
        <div data-night={night||undefined} className={cn(
