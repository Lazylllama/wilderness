import {firelight,formatHours,HEAT_TIERS,jitter,plotFor,} from "@/lib/camp-layout";
...
export function CampTent({
    ...
    return(
        <CampObject x={x} y={y}>
            <button type onClick={() => onOpen(tent)} aria-label={`${tent.name}, ${formatHours(tent.hours)} logged, ${tier.label}`}className={cn(
