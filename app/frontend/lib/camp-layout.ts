...
export const HEAT_TIERS: Record<HeatTier,{label: string; rate: number; flag: string; text: string; at: number}> = {
    kindling: {
		label: "kindling",
		rate: 80,
		flag: "#8bab6b",
...
export const FIRE_STATES: Record<FireState,{label: string; flame: number; glow: number}> = {
