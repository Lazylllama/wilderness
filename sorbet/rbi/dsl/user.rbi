...
class User
  ...
  module GeneratedAttributeMethods
    ...
    sig { params(value: ::String).returns(::String) }
    def hc_uid=(value); end

    sig { returns(T::Boolean) }
    def hc_uid?; end

    sig { returns(T.nilable(::String)) }
    def hc_uid_before_last_save; end

    sig { returns(T.untyped) }
    def hc_uid_before_type_cast; end

    sig { returns(T::Boolean) }
    def hc_uid_came_from_user?; end

    sig { returns(T.nilable([::String, ::String])) }
    def hc_uid_change; end

    sig { returns(T.nilable([::String, ::String])) }
    def hc_uid_change_to_be_saved; end

    sig { params(from: T.untyped, to: T.untyped).returns(T::Boolean) }
    def hc_uid_changed?(from: T.unsafe(nil), to: T.unsafe(nil)); end

    sig { returns(T.nilable(::String)) }
    def hc_uid_in_database; end

    sig { returns(T.nilable([::String, ::String])) }
    def hc_uid_previous_change; end

    sig { params(from: T.untyped, to: T.untyped).returns(T::Boolean) }
    def hc_uid_previously_changed?(from: T.unsafe(nil), to: T.unsafe(nil)); end

    sig { returns(T.nilable(::String)) }
    def hc_uid_previously_was; end

    sig { returns(T.nilable(::String)) }
    def hc_uid_was; end

    sig { void }
    def hc_uid_will_change!; end
    ...
    sig { returns(T.nilable([::String, ::String])) }
    def saved_change_to_hc_uid; end

    sig { params(from: T.untyped, to: T.untyped).returns(T::Boolean) }
    def saved_change_to_hc_uid?(from: T.unsafe(nil), to: T.unsafe(nil)); end
    ...
    sig { params(from: T.untyped, to: T.untyped).returns(T::Boolean) }
    def will_save_change_to_hc_uid?(from: T.unsafe(nil), to: T.unsafe(nil)); end
